...
function Step2({ onNext, onBack }: { onNext: (d: { gerberUploaded: boolean; cadUploaded: boolean; testPointsUploaded: boolean }) => void; onBack: () => void }) {
  ...
  return (
    <div className="space-y-6">
      <InfoBox>
        To begin your ICT/FCT fixture project, Elcomech requires the following materials. Please confirm and upload what you have available — our team will follow up for anything outstanding.
      </InfoBox>
