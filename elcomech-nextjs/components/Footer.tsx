      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="mb-16">
          <Link href="/" className="inline-flex flex-col group">
            <span className="text-3xl font-mono font-bold tracking-tight text-white">ELCOMECH</span>
            <div className="flex items-center gap-2">
              <span className="text-xs font-mono tracking-widest text-gray-400">SYSTEMS</span>
              <div className="w-8 h-[2px] bg-[#D40000]" />
            </div>
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-400">
              <div className="flex items-start gap-3">
                <MapPin size={16} className="text-[#D40000] shrink-0 mt-0.5" />
                <span>Bengaluru - 560091, Karnataka, India</span>
              </div>
              <div className="flex items-center gap-3">
                <Clock size={16} className="text-[#D40000] shrink-0" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              {[
                ...
                <li key={l.label}>
                  <Link href={l.href} className="hover:text-[#D40000] transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              {[
                ...
                <li key={p.slug}>
                  <Link href={`/products/${p.slug}`} className="hover:text-[#D40000] transition-colors">
                    {p.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            {subscribed ? (
              <p className="text-[#D40000] font-semibold text-sm">Thank you for subscribing!</p>
            ) : (
              <form onSubmit={handleSubscribe} className="flex">
                <input
                  ...
                  required
                  className="bg-[#1A1A1A] border border-[#333] text-white px-4 py-2 w-full text-sm focus:outline-none focus:border-[#D40000] rounded-none"
                />
                <button
                  type="submit"
                  className="bg-[#D40000] px-4 flex items-center justify-center hover:bg-[#B30000] transition-colors"
