          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 overflow-x-auto">
            <div className="flex gap-2 min-w-max">
              <button
                ...
                className={`px-4 py-2 text-xs font-bold font-mono uppercase tracking-widest border-2 transition-all ${
                  activeCategory === null ? 'bg-black text-white border-black' : 'border-gray-200 text-gray-600 hover:border-black hover:text-black'
                }`}
              >
                All Topics
              </button>
              {faqCategories.map((cat) => (
                <button
                  ...
                  className={`px-4 py-2 text-xs font-bold font-mono uppercase tracking-widest border-2 transition-all whitespace-nowrap ${
                    activeCategory === cat.category ? 'bg-black text-white border-black' : 'border-gray-200 text-gray-600 hover:border-black hover:text-black'
                  }`}
                >
                  {cat.category}
                </button>
          ...
          <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/#contact" className="inline-flex items-center gap-2 bg-[#D40000] text-white font-bold py-4 px-8 uppercase tracking-widest text-sm hover:bg-[#B30000] transition-colors">
