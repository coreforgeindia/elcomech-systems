              ...
              <div>
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Link href="/#contact" className="flex-1 bg-[#D40000] text-white font-bold py-4 px-6 uppercase tracking-widest text-sm hover:bg-[#B30000] transition-colors text-center">
                      Get Quote
                    </Link>
