...
export const products: Product[] = [
  {
    ...
    longDesc: "Elcomech's Resistive Load Banks are precision-engineered instruments that apply controlled resistive loads to generators, UPS systems, and other power sources. By simulating real-world electrical demand, they enable thorough performance validation before deployment — catching faults early and ensuring absolute operational reliability.",
  ...
  },
  {
    ...
    category: "Testing Systems",
    shortDesc: "Custom-designed testing fixtures for validating complete cable harness assemblies — every connection, verified.",
    longDesc: "Elcomech's Cable Harness Test Fixtures are built to your exact connector pinout and harness topology. Each fixture validates continuity, detects shorts, and verifies correct routing — providing instant pass/fail feedback. Custom connector panels and high-repeatability mechanics ensure consistent results across every production unit.",
  ...
  },
  {
    ...
    longDesc: "Our Heat Shrink Wire Markers permanently bond to wire surfaces when heat is applied — no slipping, no removal. Available pre-printed or blank for custom thermal/laser printing, they withstand oils, fuels, solvents, and a temperature range of -55°C to +125°C, making them ideal for aerospace, automotive, and industrial marking.",
  ...
  },
  {
    ...
    category: "Testing Systems",
    shortDesc: "Professional functional testing services for electronic and electrical assemblies — complete end-to-end validation.",
    longDesc: "Elcomech's Testing Services cover the full spectrum of electrical and electronic validation: functional testing (FCT), in-circuit testing (ICT), continuity and hipot testing, and custom test protocol development. Our in-house test infrastructure enables rapid turnaround with full data logging and traceability documentation.",
    image: "https://5.imimg.com/data5/SELLER/Default/2025/7/526767031/AJ/UK/NK/238132364/ict-fixtures-500x500.jpg",
    gallery: [
      "https://5.imimg.com/data5/SELLER/Default/2025/7/526767031/AJ/UK/NK/238132364/ict-fixtures-500x500.jpg",
      "https://5.imimg.com/data5/SELLER/Default/2025/7/529890769/OY/IV/CK/238132364/resistive-load-bank-500x500.png",
