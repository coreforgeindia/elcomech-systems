    ...
    <>
      ...
      <Layout>
        <div className="min-h-screen flex items-center justify-center bg-white pt-20">
          ...
          >
            <p className="font-mono text-[#D40000] text-8xl font-bold mb-4">404</p>
            ...
            <Link href="/" className="inline-block bg-[#D40000] text-white font-bold py-4 px-8 uppercase tracking-widest text-sm hover:bg-[#B30000] transition-colors">
              Back to Home
            </Link>
          </motion.div>
        </div>
