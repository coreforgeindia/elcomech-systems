  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Explore Elcomech Systems' complete range of industrial engineering products, including resistive load banks, RF shielded enclosures, PCB test fixtures, wiring harnesses, and more." />
      </Head>
      <Layout>
        {/* Page Header */}
